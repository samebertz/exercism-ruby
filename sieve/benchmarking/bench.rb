...
Benchmark.bmbm do |x|
  x.report("samebertz: reject! - ") { for i in 1..n; sieve_0(m); end }
  x.report("samebertz: kotp inspired - ") { for i in 1..n; sieve_1(m); end }
  x.report("hybrid 1: 1 lambda - ") { for i in 1..n; sieve_2(m); end }
  x.report("hybrid 2: Array#- + cap @sqrt - ") { for i in 1..n; sieve_3(m); end }
  x.report("hybrid 3: cap @sqrt - ") { for i in 1..n; sieve_4(m); end }
  x.report("kotp: lambdas - ") { for i in 1..n; sieve_5(m); end }
end
